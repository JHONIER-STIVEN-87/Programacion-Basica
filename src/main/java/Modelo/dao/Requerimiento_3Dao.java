    ...
    public ArrayList<Requerimiento_3> requerimiento3()  throws SQLException {
        ...
        try{
            ...
            while(resultSet.next()){
                ...
                requerimiento_3.setC_Proveedor(resultSet.getString("Proveedor"));                
                requerimiento_3.setC_Pagado(resultSet.getString("Pagado"));
                requerimiento_3.setP_Constructora(resultSet.getString("Constructora"));
